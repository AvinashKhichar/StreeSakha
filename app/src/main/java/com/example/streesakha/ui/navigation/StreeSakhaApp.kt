package com.example.streesakha.ui.navigation
 ...
 *
 * At StreeSakhaTopBar, the statusBars insets are used. But as it's only a siblings view,
...
fun StreeSakhaApp(
    ...
    onScreenProtectionChanged: @Composable (Boolean) -> Unit?,
) {
    ...
    MainScaffold(
        ...
        onScreenProtectionChanged = TODO()
    )
}
        ...
        Scaffold(
            ...
            NavHost(
                ...
                composable(route = Screen.Statistic.name) {
                    Scaffold(
                        topBar = { StreeSakhaTopBar(currentScreen.titleRes) },
                        contentWindowInsets = WindowInsets(0.dp),
                    ) { topBarPadding ->
